...
public class School { // school has A students
    ...
    public static void main(String[] args) {
        ...
        student1.setStudentInfo( "Ali", 35,'M',2345,"testing" );
        student2.setStudentInfo( "Ela", 32,'F',2378,"art" );
        student3.setStudentInfo( "Eda", 10,'M',2309,"soccer");
