...
interface downloadable{
    ...
    boolean downloadable=true;// public static final by default
    void download(); // public abstract it meant to be overriding
}

interface AndroidApps extends downloadable{// 2 variable , 1 abstract
    String AppStoreName = "Android";
}

interface AppleApps extends downloadable{// 2 variable, 1 abstract
