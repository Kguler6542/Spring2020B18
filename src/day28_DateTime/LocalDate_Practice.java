...
public class LocalDate_Practice {
    ...
    public static void main(String[] args) {
        ...
        String[] friends = { "Can" , "Elif", "Sergen"};
                       //index 0       1        2
        LocalDate CanBirthday= LocalDate.of(2020,3,5);
        LocalDate ElifBirthday= LocalDate.of(200,10,12);
        LocalDate SergenBirthday= LocalDate.of(2010,5,6);

        LocalDate[] birthdays = {CanBirthday, ElifBirthday, SergenBirthday};
                       //index  0                 1                2
